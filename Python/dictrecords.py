...
# Collect additional user input and add to the dictionary
userDetails1["fname"] = input("Enter your full name: ")
userDetails1["age"] = int(input("Enter your age: "))
userDetails1["interests"] = input("Enter your interests: ")
userDetails1["gamer"] = input("Are you a gamer? (True/False): ").lower() == "true"

# Print the updated dictionary
print("Updated userDetails1:")
print(userDetails1)
